...
plt.plot(num_qubits, add_array, 'o-r', label='Sparse Addition')
plt.plot(num_qubits, mult_array, 'o-', color='orange', label='Sparse Multiplication')
...
plt.semilogy(num_qubits, add_array, 'o-r', label='Sparse Addition')
plt.semilogy(num_qubits, mult_array, 'o-', color='orange', label='Sparse Multiplication')
plt.xlabel('Number of Qubits per Operand')
plt.ylabel('Time (seconds)')
plt.legend(loc='best')
plt.savefig('Plots/add_mult_sparse.png', dpi=600)