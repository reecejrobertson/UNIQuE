...
plt.plot(domain, curve(domain, add_params[0], add_params[1]), 'k', label='Addition Fit Curve')
plt.plot(num_qubits, mult_array, 'og', label='Multiplication Data')
plt.plot(domain, curve(domain, mult_params[0], mult_params[1]), 'r', label='Multiplication Fit Curve')
plt.xlabel('Number of Qubits Per Operand')
plt.ylabel('Time (seconds)')
plt.legend(loc='best')
